...
public class BlockTitaniumOre extends ElementsCheifsHaloBasedMod.ModElement {
	@GameRegistry.ObjectHolder("cheifshalobasedmod:titaniumore")
	public static final Block block = null;
	public BlockTitaniumOre(ElementsCheifsHaloBasedMod instance) {
		super(instance, 3);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("cheifshalobasedmod:titaniumore", "inventory"));
	}
