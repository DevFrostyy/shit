...
public class BlockMjonirOre extends ElementsCheifsHaloBasedMod.ModElement {
	@GameRegistry.ObjectHolder("cheifshalobasedmod:mjonirore")
	public static final Block block = null;
	public BlockMjonirOre(ElementsCheifsHaloBasedMod instance) {
		super(instance, 2);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mjonirore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("cheifshalobasedmod:mjonirore", "inventory"));
	}
