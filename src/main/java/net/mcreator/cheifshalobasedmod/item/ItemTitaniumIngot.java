...
public class ItemTitaniumIngot extends ElementsCheifsHaloBasedMod.ModElement {
	@GameRegistry.ObjectHolder("cheifshalobasedmod:titaniumingot")
	public static final Item block = null;
	public ItemTitaniumIngot(ElementsCheifsHaloBasedMod instance) {
		super(instance, 5);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("cheifshalobasedmod:titaniumingot", "inventory"));
	}
